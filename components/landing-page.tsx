    ...
    <motion.div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-slate-900/[0.04]" whileHover={{ scale: 1.01 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex items-center gap-2 bg-slate-100 px-4 py-2">
        ...
        <div className="flex-1 text-center">
          <div className="mx-auto max-w-[180px] rounded-md bg-white/80 px-3 py-0.5 text-[9px] text-slate-400">teztekshir.uz/classes/bio-2</div>
        </div>
      </div>
      {/* App header */}
  ...
  return (
    <motion.div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-slate-900/[0.04]" whileHover={{ scale: 1.01 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex items-center gap-2 bg-slate-100 px-4 py-2">
        ...
        <div className="flex-1 text-center">
          <div className="mx-auto max-w-[220px] rounded-md bg-white/80 px-3 py-0.5 text-[9px] text-slate-400">teztekshir.uz/assessments/submit</div>
        </div>
      </div>
      {/* App header */}
  ...
  return (
    <motion.div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-slate-900/[0.04]" whileHover={{ scale: 1.01 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex items-center gap-2 bg-slate-100 px-4 py-2">
        ...
        <div className="flex-1 text-center">
          <div className="mx-auto max-w-[220px] rounded-md bg-white/80 px-3 py-0.5 text-[9px] text-slate-400">teztekshir.uz/assessments/results</div>
        </div>
      </div>
      {/* Score header */}
              ...
              <div className="overflow-hidden rounded-2xl bg-white shadow-2xl shadow-slate-900/[0.14]">
                ...
                <div className="flex items-center gap-3 bg-slate-50 px-4 py-3">
                  ...
                  <div className="flex flex-1 items-center gap-1.5 rounded-md bg-white/70 px-3 py-1.5">
                    ...
                    <span className="truncate text-xs text-slate-400">teztekshir.uz / baholash / #4821</span>
                  </div>
                </div>
        ...
        <div className="relative bg-black/10 px-6 py-5">
          <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-3 sm:flex-row">
            <p className="text-sm text-white/40">
              &copy; {new Date().getFullYear()} teztekshir. Barcha huquqlar
              himoyalangan.
            </p>
            <p className="text-sm text-white/40">
              AI baholash platformasi
