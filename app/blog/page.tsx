      ...
      <header className="sticky top-0 z-50 bg-white/90 shadow-[0_1px_0_rgb(148_163_184/0.12)] backdrop-blur-xl">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="text-base font-bold tracking-tight text-slate-900 font-[family-name:var(--font-heading)]">teztekshir</span>
          </Link>
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white">
        <div className="mx-auto max-w-6xl px-4 pt-16 pb-12 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm font-semibold text-blue-600 uppercase tracking-wider">TezTekshir</span>
          </div>
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-slate-700 font-[family-name:var(--font-heading)]">teztekshir</span>
          </Link>
          <p className="text-xs text-slate-400">&copy; {new Date().getFullYear()} TezTekshir</p>
        </div>
      </footer>
    </div>
  );
